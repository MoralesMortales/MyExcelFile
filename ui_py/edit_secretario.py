...
# Form implementation generated from reading ui file 'ui/edit_secretario.ui'
#
...
"border-radius:4px;")
        ...
        self.frame_9.setStyleSheet("max-width:240%;")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Editar Usuario de Gestion"))
        self.label_2.setText(_translate("Form", "Cedula del Usuario"))
        self.radioButton.setText(_translate("Form", "Privilegiado"))
        self.radioButton_2.setText(_translate("Form", "No Privilegiado"))
